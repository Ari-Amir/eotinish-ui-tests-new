...
//Создание обращений прямо в БД (без юай)
    ...
    appealTypeID: String? = listOfAppealAndComplaintIDs[appealType]) : String
{
    ...
    val fileName = "$currentDir/src/test/kotlin/helpers/CreateAppealInDB/AppealData.sql"
...
//        println("ЖТ-2022-${appealId.substring(6)}")
    ...
    return getDataFromDB("SELECT x.* FROM public.appeals x WHERE id = '$appealId'", 2).substring(3)
