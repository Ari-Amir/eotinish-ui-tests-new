...
//Локаторы на карточке созданного обращения
class AppealCardPage {
    val cancelTag_button = "#kt_body > ngb-modal-window > div > div > app-attention-tag-modal > div > div.mt-5.mb-10 > button"
    ...
    val assignmentHistory_tab = "text=История поручений"
    val assignmentNumber = "#kt_content > div > div > app-appeal-registrar-view > div.row > div.col-md-5.col-xxl-4 > div > div > app-appeal-history > div.history.pb-8.pl-8.pr-8 > app-history-assignment-tab > div > div > div.i2-timeline__message > a"
