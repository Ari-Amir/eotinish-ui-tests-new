...
//Локаторы на карточке поручений
class AssignmentCardPage {
    ...
    val approve_btn = "text=Cогласовать"
    val approveOnPopup_btn = "button:has-text(\"Согласовать\")"
    ...
    val checked_btn = "text= Проверено"
    val confirm_btn = "text=Подтвердить"
    val noted_btn = "text=Принято к сведению"
    val assignmentNumber = "#kt_subheader > div > div > h5"
    val assignmentDeadline = "#mat-tab-content-1-0 > div > div:nth-child(1) > div.field.col-lg-4.ng-star-inserted > div.field__value"
    val createAdditionalAssignment_btn = "text=Создать поручение/запрос"
    ...
    val send2_btn = "div[role=\"document\"] >> text=Отправить"
    ...
    val signerOrg1Chief1 = "[aria-label=\"Options list\"] >> text=${org1Chief1.name}"
